    ...
    <div className='absolute top-0 left-0 w-full z-10'>   
     <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <ul className='hidden md:flex gap-7 text-white'>
            ...
            <a href="#Header" className='cursor-pointer hover:text-gray-400'>Reviews</a>
        </ul>
     ...
     <div className='flex justify-end p-6' cursor-pointer> 
        ...
        <ul className='flex flex-col items-center gap-2 mt-2 px-5 text-lg font-medium'>
            ...
            <a onClick={()=> setShowMobileMenu(false)} href="#Review" className='px-4 py-2 rounded-full inline-block'>Review</a>
        </ul>
     </div>
    </div>
  )
